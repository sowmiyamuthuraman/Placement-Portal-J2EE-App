...
function displayEditForm(id) {
	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			document.forms["company-form"]["company-name"].value = object.name;
			document.forms["company-form"]["company-type"].value = object.type;
			document.forms["company-form"]["description"].value = object.description;
			document.forms["company-form"]["location"].value = object.location;
			document.forms["company-form"]["package"].value = object.salary;
			document.forms["company-form"]["designation"].value = object.designation;
			document.forms["company-form"]["recruitment-date"].value = object.recruitment_date;
			document.forms["company-form"]["registration-date"].value = object.last_date;
			document.forms["company-form"]["hsc"].value = object.hsc;
			document.forms["company-form"]["sslc"].value = object.sslc;
			document.forms["company-form"]["cgpa"].value = object.cgpa;
			document.forms["company-form"]["arrear-count"].value = object.arrear_count;
			document.forms["company-form"]["package"].value = object.salary;
