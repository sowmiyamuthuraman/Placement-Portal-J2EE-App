...
public class Company {
	...
	/*
	 * @Override public String toString() { return ApplicationConstants.COMPANY_ID +
	 ...
	 * ApplicationConstants.JOB_LOCATION + jobLocation + "\n" +
	 * ApplicationConstants.DESIGNATION + designation + "\n" +
	 * ApplicationConstants.PAYMENT + payment + "\n" +
	 * ApplicationConstants.RECRUITMENT_DATE + dayOfRecruitment + "\n" +
