...
public class RetrieveDetailsDao {
	...
	public ArrayList<Student> getEligiblityList(String companyId) throws SQLException {
		Connection connection = DbConnection.getConnection();
		ArrayList<Student> list = new ArrayList<>();
		Student student;
		try {
	...
	public Company getSpecificCompany(Company companyDetail) {
		Connection connection = DbConnection.getConnection();
		try {
	...
	public ArrayList<Student> getStudentsPlacedInACompany(String id) {
