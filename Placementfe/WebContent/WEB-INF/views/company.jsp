				...
				<form class="col-lg-5 form" id="company-form">
					...
					<div class="row details__container" id="modal">
						...
						<div class="details__wrapper">
							...
							<input type="text" name="company-name" class="row details__input" />
						</div>
						<div>
							<br>
						...
						<div class="details__wrapper">
							...
							<textarea name="description" class="row details__input"></textarea>
						</div>
						<div class="details__wrapper">
						...
						<div class="details__wrapper">
							...
							<input type="text" name="designation" class="row details__input" />
						</div>
						<span class="errormsg"></span>
						<div class="details__wrapper">
							<label class="row" for="package">PACKAGE</label>
							<input type="text" name="package" class="row details__input" />
						</div>
						<span class="errormsg"></span>
						<div class="details__wrapper">
							<label class="row" for="recruitment-date">DATE OF
								RECRUITMENT</label>
							<input type="date" name="recruitment-date"
