	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			if (this.responseText == "success") {
				...
				document.getElementsByClassName("details-table")[0].removeChild(detail);
				...
				setTimeout(function(){document.getElementsByClassName("delete_msg")[0].style.display="none";},6000);
			}
		} else {
			console.log("error");
		}
